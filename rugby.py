...
data=pd.read_csv('C:/Users/Darragh/Documents/Python/rugby/rugby_results_urc_2022_2023.csv',parse_dates=['Date'])
...
with st.expander('Analysis of Betting Results across 1 to 5 factors'):
    ...
    reset_data.loc['Winning_Bets']=(reset_data.loc[reset_data.index.isin({'1.0'})].sum(axis=0))
    reset_data.loc['Losing_Bets']=(reset_data.loc[reset_data.index.isin({'-1.0'})].sum(axis=0))
    # reset_data.loc['Losing_Bets']=(reset_data.loc['-1.0'])
    # reset_data.loc['No. of Bets Made'] = reset_data.loc['1.0'] + reset_data.loc['-1.0']
    reset_data.loc['No. of Bets Made'] = reset_data.loc['Winning_Bets'] + reset_data.loc['Losing_Bets'] 
    ...
    reset_data.loc['% Winning'] = (reset_data.loc['Winning_Bets'] / (reset_data.loc['Winning_Bets']+reset_data.loc['Losing_Bets'])  ).replace({'<NA>':np.NaN})
    ...
    reset_data = reset_data.style.format("{:.2f}", na_rep='-')
