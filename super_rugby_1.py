...
results_excel=pd.read_excel('C:/Users/Darragh/Documents/Python/rugby/super_rugby_2024.xlsx')

# id_excel=pd.read_excel('C:/Users/Darragh/Documents/Python/rugby/super_rugby_id.xlsx')

def csv_save(x):
    x.to_csv('C:/Users/Darragh/Documents/Python/rugby/super_rugby_2024.csv')
    return x
...
team_names_id=pd.read_csv('C:/Users/Darragh/Documents/Python/rugby/super_rugby_id.csv')
# st.write(team_names_id)
# st.write(pd.read_csv(url))
# data=pd.read_csv(url,parse_dates=['Date'])

local='C:/Users/Darragh/Documents/Python/rugby/super_rugby_2024.csv'
...
with placeholder_2.expander('Betting Slip Matches'):
    ...
    df_extract=betting_matches.loc[:,['Week','Date','Home Team','Away Team','total_factor','bet_on','Spread','power_pick','home_cover_sign','away_cover_sign',
                      'home_turnover_sign','away_turnover_sign','momentum_pick']].set_index(['Date','Home Team','Away Team','total_factor','bet_on','Spread'])
    
    st.write(df_extract.loc[df_extract['Week']==(finished_week+1)].reset_index().set_index(['Week','Date','Home Team','Away Team','total_factor','bet_on','Spread']).style.format({'home_power':"{:.1f}",'away_power':"{:.1f}",'result':"{:.0f}",'Home Points':"{:.0f}",'Date':"{:%d.%m.%Y}",
